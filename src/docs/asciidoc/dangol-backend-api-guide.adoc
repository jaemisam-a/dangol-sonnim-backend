...
==== 1. 메뉴 등록
새로운 메뉴 정보를 등록합니다.
(폼데이터 형식에서의 http-request가 보기 안좋게 나타나는 현상이 있습니다. 해결책을 모색해 볼 예정입니다.)

- Request
include::{snippets}/menu/create/http-request.adoc[]
include::{snippets}/menu/create/request-parts.adoc[]
include::{snippets}/menu/create/request-parameters.adoc[]
...
include::{snippets}/menu/update/request-parameters.adoc[]
- Response
