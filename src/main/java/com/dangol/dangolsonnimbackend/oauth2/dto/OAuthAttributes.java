...
public class OAuthAttributes {
    ...
    /**
     * @param oauth2UserInfo OAuth2UserInfo에서 socialId(식별값), nickname, imageUrl을 가져와서 build
     * @implNote email에는 UUID로 중복 없는 랜덤 값 생성
     * @implNote of메소드로 OAuthAttributes 객체가 생성되어, 유저 정보들이 담긴 OAuth2UserInfo가 소셜 타입별로 주입된 상태
     */
